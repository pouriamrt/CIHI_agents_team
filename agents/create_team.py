...
def initialize_team(model, session_state):
    ...
    return Team(
        ...
        instructions=[
            ...
            "When done with creating a visualization, tell the user to refresh the plot section to see the new chart or visualization.",
            "For questions regarding key findings, use the CIHI Web Agent to extract the key points.",
            "For questions about the data availability and quality of the data, delegate the task to the MethodologyNotesAgent.",
            "For questions about the data dictionary, data elements, and data codes, delegate the task to the DataDictionaryAgent.",
